...
# ==============================================================================
#  Rocket.Chat Installer by AmirKtb
#  Website: katebasber.ir
# ==============================================================================
...
print_banner() {
    clear
    echo -e "${GREEN}==============================================================${NC}"
    echo -e "${GREEN}   Rocket.Chat One-Click Installer by AmirKTB   ${NC}"
    echo -e "${GREEN}==============================================================${NC}"
    echo -e "   Website: katebsaber.ir"
    echo -e ""
}
...
DEFAULT_DIR="$HOME/amirktb-rocketchat"
...
#!/bin/bash
# Auto-generated by Amirktb Installer
cd $INSTALL_DIR
